...
function AddItemModal() {
    ...
    return (
        ...
        <div className="modal m-0">
            ...
            <div className="modal-box w-max flex flex-col justify-center items-center bg-pnc">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-14 sm:w-14" fill="none" viewBox="0 0 24 24" stroke="white">
